...
fn spawn_first_gravity_region(
    ...
    // commands.spawn(new_gravity_region(
    //     true,
    //     &play_world,
    //     &level,
    //     &grav_mat,
...
fn new_gravity_region(
    ...
    let q = meshes.add(Mesh::from(shape::Quad::new(Vec2::new(width, height))));
    ...
    (
        MaterialMesh2dBundle {
            mesh: q.into(),
            material,
            transform: Transform::from_translation(Vec3::new(200.0 + width / 2.0, 0.0, 3.0)),
            ..default()
        },
    ...
    fn build(&self, app: &mut App) {
        app.add_collection_to_loading_state::<_, GravityAssets>(GameState::AssetLoading)
            ...
            .add_systems(
                ...
                (setup_gravity_assets, spawn_first_gravity_region).chain(),
            );
    }
}
