...
pub fn new_scoring_region(score_delta: i32,
			  offset: Vec2,
			  dim: Vec2) -> impl Bundle {
...
fn check_scoring_region_collisions(mut commands: Commands,
...
impl Plugin for ScoringRegionPlugin {
	...
	app.register_type::<ScoringRegion>()
	    .add_systems(Update, check_scoring_region_collisions.run_if(in_state(GameState::Playing)));
    }
}
